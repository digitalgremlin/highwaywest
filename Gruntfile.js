...
module.exports = function(grunt) {
	...
	grunt.initConfig({
        ...
        bower_concat: {
              all: {
                ...
                cssDest: 'dist/css/libraries.min.css',
                exclude: [                  
                  'foundation',
                  'modernizer'    
	...
	grunt.registerTask('publish', ['compile-jade', 'compile-sass', 'clean:dist', 'validate-js', 'useminPrepare', 'copy:dist', 'newer:imagemin', 'concat', 'cssmin', 'uglify', 'usemin', 'bower_concat']);
